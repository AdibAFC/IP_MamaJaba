...
<body>
    <nav>
        ...
        <div class="sub-menu-wrap" id="subMenu">
            <div class="sub-menu">
                ...
                <a href="../Contact_Us/contactUs.html" class="sub-menu-link">
    ...
    <div class="history">
            <a href="#ride-history" onclick="fetchHistory()">View Rider's Past History</a>
    </div>
    <div id="ride-history" style="display: none;">
